...
|[Анализ показателей сервиса доставки еды](https://github.com/Daniil-Pavlov/online_store_data-analysis) | Расчет основных метрик по данным работы интернет магазина у которого имеется услуга доставки и их последующая визуализация.| PostgreSQL, Redash |
