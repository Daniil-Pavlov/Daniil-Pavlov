...
| [Визуализация данных работы службы поддержки](https://github.com/Daniil-Pavlov/visualization_support_service)  | Составление Dashboard Canvas и оформление дашборда с целью визуализации ключевых метрик по данным работы службы поддержки в системе по бронированию отелей| Tableau  | 
|[Анализ показателей сервиса доставки еды](https://github.com/Daniil-Pavlov/online_store_data-analysis) | Анализ текущих показателей сервиса по продаже продуктов питания, в том числе с применением оконных функций и подзапросов, оценка влияния проведенных коррекций в системе оплаты труда, сравнение эффективности проведенных рекламных компаний с последующей визуализацией полученных результатов.| PostgreSQL, Redash |
