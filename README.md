...
|[Анализ показателей сервиса доставки еды](https://github.com/Daniil-Pavlov/online_store_data-analysis) | Расчет основных метрик, в том числе с применением оконных функций и подзапросов, по данным работы сервиса доставки еды и их последующая визуализация.| PostgreSQL, Redash |
